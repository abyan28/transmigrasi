        ...
        isSubmenuOpen(groupIndex, itemIndex) {
            ...
            return this.openSubmenus[key] || false;
                ...
                isActive(path) {
                    ...
                    const semuaJalur = ['', 'kawasan', 'sp', 'sp/inventaris', 'sp/fasilitas', 'infrastruktur', 'transmigran', 'rumah', 'lahan', 'kependudukan/rekap', 'poktan', 'alsintan', 'saprotan', 'komoditas', 'penanaman', 'panen', 'panen/rekap', 'pengaduan', 'pengaduan/rekap', 'laporan', 'wilayah', 'master/satuan', 'pengguna', 'pengaturan/role', 'audit-log', 'panduan', 'tentang'];
