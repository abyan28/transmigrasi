    ...
    <div class="grid gap-6 lg:grid-cols-[20rem_1fr]">
        ...
        <div class="min-w-0 space-y-6">
            ...
            <section class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
                <h2 class="text-theme-sm font-semibold text-gray-800 dark:text-white/90">Kepemilikan</h2>
            ...
            {{-- Kondisi --}}
            <section class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
                <h2 class="text-theme-sm font-semibold text-gray-800 dark:text-white/90">Kondisi Alat</h2>
