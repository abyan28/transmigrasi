{{--
    ...
    Bagian benih mengikuti kolom "laporan saprotan.jpeg" di refs/: identitas
    poktan dan ketua, kontak, jumlah anggota, luas lahan, volume benih,
    varietas, tahun pengadaan, sumber dana, jadwal tanam.

    Bagian non-benih (pupuk, pestisida, mulsa) hanya menampilkan
    penyalurannya, sebab sarana itu tidak tertaut ke satu penanaman tertentu.
...
@section('content')
    <x-sim.kerangka-laporan slug="saprotan"
        ...
        <x-slot:catatan>
            Jadwal tanam adalah rencana dari berita acara penyaluran, bukan
            realisasi. Selisihnya dengan periode tanam yang sebenarnya justru
            berguna diamati.
        </x-slot:catatan>
