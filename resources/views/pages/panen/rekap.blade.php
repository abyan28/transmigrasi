...
@section('content')
    {{--
        Seluruh isian halaman ini datang dari closure `susunRekapPanen` pada
        routes/web.php, yang dipakai bersama rute `panen.rekap` dan
        `panen.rekap.kelompok`. Dipusatkan di sana agar kedua rute tidak
        ...
        @else
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    <caption class="sr-only">Rekap hasil panen</caption>
