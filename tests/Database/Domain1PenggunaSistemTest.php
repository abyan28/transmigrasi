...
it('membuat tabel Domain 1', function () {
    foreach (['role', 'permission', 'role_permission', 'user', 'kode_pemulihan_sandi', 'pending_email_changes', 'audit_log', 'notifikasi'] as $tabel) {
