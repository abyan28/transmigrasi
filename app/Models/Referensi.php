 ...
 * cukup INSERT tanpa ALTER TABLE. `jenis` ber-ENUM 14 nilai (bukan referensi:
 * enum berperilaku tetap ENUM). `nilai_skor` hanya untuk jenis `kondisi`;
 * `bidang_id` (self-FK) hanya untuk jenis `kategori_pengaduan`.
 *
...
class Referensi extends Model
{
    ...
    {
        return $this->belongsTo(self::class, 'bidang_id', 'id_referensi');
    }
}
