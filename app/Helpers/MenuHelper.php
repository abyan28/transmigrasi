...
{
    /**
     * Menyusun seluruh kelompok menu sidebar beserta izin yang dibutuhkan.
     *
     * Sejak role menjadi dinamis (agents/rules.md bagian 5), menu tidak lagi
     ...
     */
    public static function definisiMenu()
    {
        return [
            [
                'title' => 'Menu',
    ...
    /**
     * Menyusun kelompok menu yang berhak dilihat pengguna saat ini.
     *
     * Item tanpa izin yang sesuai tidak dirender sama sekali, bukan sekadar
     ...
     *
     * @param  string|null  $permission  Nama izin, contoh `transmigran.lihat`
     * @return bool True bila berhak mengakses
     */
    public static function bolehLihat($permission)
    {
        if ($permission === null) {
            return true;
        }
    ...
    /**
     * Memeriksa apakah sebuah path menu sedang aktif.
     *
     * @param  string  $path  Path menu, contoh `/transmigran`
     * @return bool True bila URL saat ini cocok dengan path tersebut
     */
    ...
    /**
     * Mengambil markup SVG ikon menu berdasarkan namanya.
     *
     * Ikon disimpan sebagai SVG sebaris, bukan paket font ikon, agar tidak
     * membebani kuota pengguna lapangan (`agents/ui-spec.md` bagian 3.6).
     *
     * @param  string  $iconName  Nama ikon, contoh `dashboard`
     * @return string Markup SVG, atau string kosong bila ikon tidak ada
     */
