...
class PoktanController extends Controller
{
     ...
     *
     * Logika pemetaan dipindahkan ke `App\Support\PenyajianPoktan` (Task 10.5)
     * supaya halaman daftar/rincian dan Laporan Poktan membaca satu sumber.
     *
     * @return array<string, mixed>
     */
    private function baris(Poktan $p): array
    {
        return PenyajianPoktan::baris($p);
    }
    ...
    {
        return PenyajianPoktan::barisAnggota($a);
    }
    ...
    {
        return PenyajianPoktan::identitasKetua($p);
    }
