...
8g. **Indikator produksi pada dashboard memakai agregat kawasan, bukan penjumlahan tabel transaksi** (ditegaskan 2026-08-24). Keduanya menjawab pertanyaan berbeda dan berbeda skala ratusan kali; menurunkan yang satu dari yang lain membuat dashboard menyatakan kawasan berisi ribuan keluarga hanya menanam beberapa hektare. Agregat itu tetap wajib memenuhi kedua identitas pada poin 9 dan 11, sehingga dua kartu yang bersebelahan tidak dapat saling membantah.
...
9. **Satu penanaman hanya boleh satu panen** (ditetapkan pemilik proyek 2026-08-24). Luas yang ditanam wajib tertutup habis pada satu pencatatan: **realisasi panen + puso = realisasi tanam**, tepat. Realisasi tanam 2 ha tidak dapat dipanen 1,5 ha lalu menyusul 0,5 ha dari penanaman yang sama.
9a. **Panen bertahap DICABUT** pada tanggal yang sama, beserta seluruh konsep "belum dipanen". Identitas di atas dahulu bersuku tiga dengan belum dipanen sebagai selisihnya, dan bentuk itu keliru pada dua hal. Pertama, satu hamparan yang ditanam serentak matang serentak pula, sehingga sisa yang tidak tercatat bukan tanaman yang masih hidup melainkan pencatatan yang menggantung. Kedua, sistem tidak pernah punya cara menutup sisa itu: form membatasi isian dengan sisa luas lalu membiarkan petugas berhenti, dan tidak ada yang menagihnya. Akibatnya nyata pada data contoh — penanaman November 2025 masih tercatat menyisakan 0,80 ha sampai Agustus 2026, sepuluh bulan tanpa pernah ditutup.
...
11. **Filter rentang tahun dipasang di halaman daftar bersumbu waktu** (`/panen`, `/penanaman`, `/audit-log`) **dan di bilah filter halaman laporan yang barisnya transaksi** (Hasil Panen, Alsintan, Saprotan — tiap baris milik tepat satu tahun pengadaan). **DILARANG di halaman rekap agregat**: rekap panen yang dijumlah lintas tahun membuat luas 2 ha yang ditanami tiga tahun terbaca 6 ha (§9 poin 8b). Larangan "bukan di halaman laporan" versi 2026-08-28 dicabut — ia bersandar pada §9 poin 8b yang tidak berlaku untuk baris transaksi.
