...
10. **Halaman Data Master Wilayah menyajikan keempat tingkat dalam SATU tabel**, dengan satu tingkat aktif pada satu waktu (2026-09-07, menggantikan daftar campuran). Tingkat bawaan adalah Provinsi dan tidak ada pilihan "Semua tingkat". Penyaring **wajib mencantumkan jumlah tiap tingkat**. Kolom mengikuti tingkat aktif serta seluruh leluhurnya: Kabupaten menampilkan Provinsi; Kecamatan menampilkan Kabupaten dan Provinsi; Desa menampilkan Kecamatan, Kabupaten, dan Provinsi. Pencarian mencakup nama wilayah aktif, seluruh leluhur yang ditampilkan, dan kode wilayah aktif.
