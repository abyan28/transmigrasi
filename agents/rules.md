...
8c. **Penyaring periode rekap memakai TAHUN TANAM, bukan tahun panen.** Penanaman yang belum dipanen tidak memiliki periode panen, sehingga menyaring dengan tahun panen justru membuang baris yang paling perlu terlihat. Satu baris karena itu berarti "musim tanam tahun tersebut", dan panen yang jatuh pada tahun berikutnya tetap terhitung pada tahun tanamnya tanpa terbelah dua.
