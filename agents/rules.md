...
6. **Bidang lahan TIDAK memegang dokumennya sendiri** (ditetapkan 2026-09-02, Putaran 12). Legalitas lahan berada pada dua tingkat yang berbeda, dan keduanya bukan tingkat bidang:
   - **SHM** meliputi **seluruh lahan satu keluarga**, pekarangan maupun lahan usaha, sehingga melekat pada `transmigran` dan diunggah **sekali**.
...
6a. **Halaman lahan menampilkan keduanya sebagai bacaan**, beserta tautan ke tempat penyuntingannya. Menyediakan unggahan di sana melahirkan salinan sertifikat yang sama pada tiap bidang, lalu satu digit salah hanya terbetulkan di sebagian.
...
9. **Jumlah pada poin 8 kini BATAS yang ditegakkan basis data**, bukan sekadar kewajaran. Ditegakkan `UNIQUE (transmigran_id, peruntukan_lahan)` pada tabel `lahan`, sepola dengan `uq_rumah_transmigran` (6a.6): aturan yang hanya dijaga form dapat ditembus lewat impor maupun akses langsung.
9a. ~~Ketentuan lama (dicabut 2026-09-02): "Sistem juga tidak menolak bidang ketiga: bila satu jatah lahan usaha terletak pada dua petak berkoordinat berbeda, keduanya tetap perlu dicatat tersendiri."~~ **Konsekuensi yang diterima sadar:** bila kelak ditemukan keluarga dengan lahan usaha di dua petak terpisah, sistem menolak menyimpannya dan petugas harus menjumlahkan luasnya serta memilih satu koordinat. Pemilik proyek menyatakan keadaan itu tidak ada di Kobalima Timur.
9b. **Relasi tetap satu-ke-banyak** dengan foreign key pada `lahan`, sebab satu KK memang memegang dua bidang berbeda peruntukan sehingga satu-ke-satu tidak mungkin. Yang berubah hanya penegakan jumlahnya per peruntukan.
